...
const sampleJobs = [
  { 
    ...
    status: 'รอดำเนินการ', department: 'ช่างไฟฟ้า', location: 'อาคาร A ชั้น 3',
    updatedAt: '2025-11-20 12:00', priority: 'ปานกลาง', dueDate: '2024-11-22'
  },
  { 
    id: 'J002', name: 'เปลี่ยนหลอดไฟ', date: '2024-11-14', 
    technician: 'สมชาย ใจดี', technicianId: 'tech1', creator: 'Admin',
    status: 'กำลังทำ', department: 'ช่างไฟฟ้า', location: 'อาคาร B ชั้น 1',
  ...
  { 
    ...
    status: 'กำลังทำ', department: 'ช่างไฟฟ้า', location: 'อาคาร C',
  ...
  { 
    ...
    status: 'รออนุมัติ', department: 'ช่างไฟฟ้า', location: 'ห้องประชุม 1',
    updatedAt: '2025-11-20 09:00', priority: 'ต่ำ', dueDate: '2024-11-25'
  },
  { 
    id: 'J007', name: 'เครื่องปรับอากาศเสีย', date: '2024-11-21', 
    technician: 'ไม่มีช่าง', technicianId: null, creator: 'Admin',
    status: 'รออนุมัติ', department: 'ช่างไฟฟ้า', location: 'อาคาร A ชั้น 5',
  ...
  { 
    ...
    status: 'รออนุมัติ', department: null, location: 'ไม่ระบุ', // แก้ไข department: '' เป็น null
    updatedAt: '2025-11-10 09:00', priority: '', dueDate: '2024-11-12' 
  },
  { 
    id: 'J100', name: 'ทาสีกำแพง', date: '2024-11-18', 
    technician: 'ไม่มีช่าง', technicianId: null, creator: 'Admin',
    status: 'กำลังทำ', department: 'โครงสร้าง', location: 'โรงอาหาร', // Logic Error (In Progress, No Tech)
